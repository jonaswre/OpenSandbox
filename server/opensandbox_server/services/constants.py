...
class SandboxErrorCodes:
    ...
    # Windows runtime error codes
    WINDOWS_VM_NOT_FOUND = "WINDOWS::VM_NOT_FOUND"
    WINDOWS_VM_CREATE_FAILED = "WINDOWS::VM_CREATE_FAILED"
    WINDOWS_VM_DELETE_FAILED = "WINDOWS::VM_DELETE_FAILED"
    WINDOWS_VM_PAUSE_FAILED = "WINDOWS::VM_PAUSE_FAILED"
    WINDOWS_VM_RESUME_FAILED = "WINDOWS::VM_RESUME_FAILED"
    WINDOWS_VM_NOT_RUNNING = "WINDOWS::VM_NOT_RUNNING"
    WINDOWS_VM_NOT_PAUSED = "WINDOWS::VM_NOT_PAUSED"
    WINDOWS_BOOT_TIMEOUT = "WINDOWS::BOOT_TIMEOUT"
    WINDOWS_INVALID_PORT = "WINDOWS::INVALID_PORT"
